...
class LogCLassAll:
    def __init__(self):
        ...
        if not self.logger.handlers:
            self.fh = logging.FileHandler("log/bot_new.log", encoding="utf-8")
        ...
        if not aiogram_logger.handlers:
            fh_aiogram = logging.FileHandler("log/aiogram.log", encoding="utf-8")
        ...
        if not sa_logger.handlers:
            fh_sa = logging.FileHandler("log/sqlalchemy.log", encoding="utf-8")
